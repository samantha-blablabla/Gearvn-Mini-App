                ...
                <div className="bg-white rounded-xl p-4 border border-gray-100 shadow-sm">
                    <div className="w-full">
                        ...
                        <div className="flex items-center justify-between mt-3">
                            ...
                            <button className="flex items-center gap-1.5 px-3 py-1.5 bg-primary text-white rounded-full text-[11px] font-bold active:scale-95 transition-transform">
                                <i className="ph-fill ph-chat-circle-text text-sm"></i>
                                Chat ngay
                            </button>
                        </div>
                    </div>
