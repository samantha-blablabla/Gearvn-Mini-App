            ...
            >
              ...
              <div className="shrink-0 flex items-center justify-center">
                 <div className={`w-6 h-6 rounded-full border-[2px] flex items-center justify-center transition-colors ${selectedProduct === 3 ? 'border-primary bg-primary' : 'border-gray-300'}`}>
                      {selectedProduct === 3 && <i className="ph ph-check text-white text-sm"></i>}
                  </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-5">
            <div className="space-y-2">
               ...
               <div className="relative">
                  ...
                  <i className="ph ph-caret-down absolute right-4 top-1/2 -translate-y-1/2 text-gray-500 pointer-events-none"></i>
               </div>
            </div>
                ...
                <div className="space-y-2">
                   ...
                   <div className="grid grid-cols-2 gap-3">
                      ...
                      <div className="relative">
                         ...
                         <i className="ph ph-caret-down absolute right-3 top-1/2 -translate-y-1/2 text-gray-500 pointer-events-none"></i>
                      </div>
                   </div>
                </div>
