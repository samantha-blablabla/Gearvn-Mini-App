      ...
      {step === 1 && (
        <div className="p-4 space-y-4 animate-in fade-in slide-in-from-right-4 duration-300">
          ...
          <div className="bg-blue-50 p-4 rounded-xl flex gap-3 border border-blue-100">
             <i className="ph-bold ph-info text-blue-600 text-xl"></i>
          ...
          {shippingMethod === 'store' ? (
             <div className="space-y-4 animate-in fade-in slide-in-from-bottom-2 duration-300">
                ...
                <div className="rounded-xl overflow-hidden border border-gray-200 shadow-sm bg-white">
                   ...
                   <div className="p-4">
                      <div className="flex items-start gap-3">
                         <i className="ph-bold ph-map-pin text-primary mt-0.5"></i>
                         <div>
                ...
                <div className="bg-orange-50 p-4 rounded-xl flex gap-3 border border-orange-100">
                   <i className="ph-bold ph-warning text-orange-600 text-xl"></i>
             ...
             <div className="space-y-4 animate-in fade-in slide-in-from-bottom-2 duration-300">
                ...
                <div className="space-y-2">
                 ...
                 <div className="bg-blue-50 p-4 rounded-xl flex gap-3 border border-blue-100">
                   <i className="ph-bold ph-truck text-blue-600 text-xl"></i>
                   <p className="text-xs text-blue-800 leading-relaxed font-medium">
